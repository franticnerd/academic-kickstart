...
- **Teaching Assistant**: [Hanjun Dai](https://www.cc.gatech.edu/~hdai8/)
- **Piazza**: TBD 
...
|---------|-------------------------------------------------|--------------------|---------|----------|
| 1/7/19  | Course Overview                                 | Sign up for Piazza |         | [GT Honor Code](https://policylibrary.gatech.edu/student-affairs/academic-honor-code)   |
| 1/9/19  | Math Basics: Linear Algebra        |                    |         |  [Linear Algebra Review by Zico Kolter](http://cs229.stanford.edu/section/cs229-linalg.pdf)   |
| 1/14/19 | Math Basics: Probability and Statistics   |                    |         |   [Probability Theory Review by Andrew Moore](http://www.cs.cmu.edu/~./awm/tutorials/prob.html)      |
| 1/16/19 | Math Basics: Information Theory       | AS1 Out            |         |   [Visual Information Theory by Chris Olah](http://colah.github.io/posts/2015-09-Visual-Information/)    |
...
| 1/28/19 | Introduction to Clustering Analysis and K-Means |                    | AS1 Due |          |
| 1/30/19 | Gaussian Mixture Model                          |                    |         |          |
| 2/4/19  | Hierarchical Clustering                         |                    |         |          |
| 2/6/19  | Density-Based Clustering                        | AS2 Out            |         |          |
| 2/11/19 | Evaluation of Clustering Algorithms             |                    |         |          |
| 2/13/19 | Dimension Reduction                             |                    |         |          |
| 2/18/19 | Kernel Density Estimation                       |                    |         |          |
| 2/20/19 | Midterm Review                                  |                    | AS2 Due |          |
| 2/25/19 | **Midterm Exam**                                    |                    |         |          |
| 2/27/19 | Decision Tree and Random Forest                 |                    |         |          |
| 3/4/19  | Decision Tree and Random Forest                 |                    |         |          |
| 3/6/19  | Linear Regression                               |                    |         |          |
| 3/11/19 | Linear Regression                               | AS3 Out            |         |          |
| 3/13/19 | Naïve Bayes and Logistic Regression             |                    |         |          |
| 3/18/19 | **No Class** (Spring Break)                         |                    |         |          |
| 3/20/19 | **No Class** (Spring Break)                         |                    |         |          |
| 3/25/19 | Support Vector Machine                          |                    |         |          |
| 3/27/19 | Support Vector Machine                          |                    | AS3 Due |          |
| 4/1/19  | Neural Networks                                 |                    |         |          |
| 4/3/19  | Neural Networks                                 | AS4 Out            |         |          |
...
- **Office Hours**:
  - Chao Zhang (Instructor), Weds 3:30-4:20pm; 
  - Hanjun Dai (Teaching Assistant), Mons 1-2pm.
...
- **Project (20%)**
  - You are expected to complete a project on computational data analysis with real-life data. Your project needs to be clear about 1) the data you are using; 2) the problem you are attempting to solve; 3) the method you are using; 4) the results and conclusion you obtain.
